...
import { CodeIcon, ExternalLinkIcon, MagicWandIcon, PlayIcon, StackIcon } from "@radix-ui/react-icons";
...
function GetStartedContent() {
    return (
        <div className="overflow-y-auto">
            <p className="text-muted-foreground mb-2">This template is a starting point for building your fullstack web application.</p>
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        The{" "}
                        <a href="https://dashboard.convex.dev/" className="underline underline-offset-4 hover:no-underline" target="_blank">
                            Convex dashboard
                        </a>{" "}
            ...
            <div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                    ...
                    <Resource title="Stack articles" href="https://stack.convex.dev/">
                        Learn about best practices, use cases, and more from a growing collection of articles, videos, and walkthroughs.
                    </Resource>
                    <Resource title="Discord" href="https://www.convex.dev/community">
                        Join our developer community to ask questions, trade tips & tricks, and show off your projects.
                    </Resource>
                    <Resource title="Search them all" href="https://search.convex.dev/">
                        Get unblocked quickly by searching across the docs, Stack, and Discord chats.
                    </Resource>
                </div>
            </div>
        </div>
...
function Resource({ title, children, href }: { title: string; children: ReactNode; href: string }) {
    return (
        <Button asChild variant="secondary" className="flex h-auto flex-col items-start justify-start gap-2 whitespace-normal p-4 font-normal">
